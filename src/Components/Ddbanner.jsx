...
import banner from '../assets/DomesticD.png'
      ...
      <div className='absolute inset-0 z-20 flex flex-col justify-center px-25 pt-10'>
            <nav aria-label="Breadcrumb">
              <ol className="flex items-center  gap-1 text-sm text-white">
                ...
                <li>
                  <a href="#">Domestic Destinations</a>
                </li>
              </ol>
            </nav>
            <h2 className='text-white text-4xl  mt-2'>Domestic Destinations</h2>
            <p className='text-white text-[16px]  mt-3'>Explore India</p>
            </div>
    </div>
  )
}
